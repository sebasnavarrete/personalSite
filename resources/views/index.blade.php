    ...
    <div class="intro">
        ...
        <div class="social-icons">
            <ul class="list-inline">
                <li><a target="_blank" href="https://www.facebook.com/sebasnavarrete"><i class="fa fa-facebook"></i></a></li>
                <li><a target="_blank" href="https://twitter.com/Sebas_Navarrete"><i class="fa fa-twitter"></i></a></li>
                <li><a target="_blank" href="https://co.linkedin.com/in/sebastián-navarrete-05877086"><i class="fa fa-linkedin"></i></a></li>
            </ul>
        </div> <!-- /.social-icons -->
    </div>
